...
def main():
    """Main function."""
    logging.basicConfig(filename='best_log.txt', level=logging.INFO)
    logging.info('$ python3 code/best.py')
    ...
    WriteCSV(states, 'best.csv')

    logging.info('Writing error plot data.')
    WriteError(error, 'best_error_data.txt')
